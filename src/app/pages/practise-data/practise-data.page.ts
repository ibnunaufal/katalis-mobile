...
@Component({
  selector: 'app-practise-data',
  templateUrl: './practise-data.page.html',
  styleUrls: ['./practise-data.page.scss'],
})
export class PractiseDataPage implements OnInit {
  ...
  constructor(
    ...
    this.route.queryParams.subscribe((params) => {
      if (params) {
        ...
        this.academicService.getPractice(this.data.detailId).then((res: any) => {
          console.log(res);
  ...
  SendResult() {
    ...
    this.waktuHabisTest();
    this.academicService.postPractice(this.finalResult, this.data.detailId).then((res: any) => {
